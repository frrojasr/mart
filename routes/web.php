...
Route::get('envios/get_shipping_price', 'EnvioController@obtenerPrecioDeEnvio');
Route::get('envios/sucursales', 'EnvioController@obtenerSucursales')->name('obtenerSucursales');
//pickits
Route::post('envios/get-pickits-points', 'PickitController@getPoints');
Route::post('envios/get-pickits-price-point', 'PickitController@obtenerPrecioPunto');
Route::post('envios/get-pickits-price-domicilio', 'PickitController@obtenerPrecioDomicilio');

Route::get('envios/etiqueta_envio_pickit/{transaction_id}', 'PickitController@generarEtiqueta')->name('envios.etiqueta_envio_pickit');
...
Route::group(['middleware' => ['auth', 'locale', 'permission']], function () {
    ...
    //envios
    Route::get('envios', 'EnvioController@index')->name('envio.index');
    Route::post('envios', 'EnvioController@createOrUpdate')->name('envio.creaOrUp');

    Route::get('envios/etiqueta_envio_oca', 'EnvioController@etiquetaEnvioOca')->name('envios.etiqueta_envio_oca');
